          	...
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="tutorID" class="form-control">
								...
								{
									$selected = ($user['ID'] == $this->input->post('tutorID')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="lecturerRoomID" value="<?php echo $this->input->post('lecturerRoomID'); ?>" class="form-control" id="lecturerRoomID" />
						</div>
					</div>
					<div class="col-md-6">
