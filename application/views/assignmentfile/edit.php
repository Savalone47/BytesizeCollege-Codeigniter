    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Assignmentfile Edit</h3>
            </div>
			<?php echo form_open('assignmentfile/edit/'.$assignmentfile['fileID']); ?>
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="assignmentID" class="form-control">
								...
								{
									$selected = ($assignment['id'] == $assignmentfile['assignmentID']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="studentID" class="form-control">
								...
								{
									$selected = ($student['studentID'] == $assignmentfile['studentID']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="file" value="<?php echo ($this->input->post('file') ? $this->input->post('file') : $assignmentfile['file']); ?>" class="form-control" id="file" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="deleteStatus" value="<?php echo ($this->input->post('deleteStatus') ? $this->input->post('deleteStatus') : $assignmentfile['deleteStatus']); ?>" class="form-control" id="deleteStatus" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="time_stamp" value="<?php echo ($this->input->post('time_stamp') ? $this->input->post('time_stamp') : $assignmentfile['time_stamp']); ?>" class="form-control" id="time_stamp" />
						</div>
					</div>
				</div>
			</div>
