<!--<div class="top-menu">
    <ul class="nav navbar-nav pull-right">
        ...
        <li class="dropdown dropdown-extended dropdown-notification" id="header_notification_bar">
            <a href="<?php echo base_url('notification/index')?>" class="dropdown-toggle"
           ...
           <ul class="dropdown-menu">
                ...
                <li>
                    ...
                    <div class="dropdown-menu-footer">
                        <a href="<?php echo site_url('notification/index')?>"> All notifications </a>
                    </div>
                </li>
            </ul>
        </li>
...
<div class="top-menu">
    <ul class="nav navbar-nav pull-right">
        ...
        <li class="dropdown dropdown-extended dropdown-notification" id="header_notification_bar">
            ...
            <ul class="dropdown-menu">
                <?php
                    if (is_array($get_notice) || is_object($v))
                    {
                        foreach ($get_notice as $v)
                        {
                ...
                <li class="external">
                    <h3><span class="bold">Notifications</span></h3>
                    <span class="notification-label purple-bgcolor">New 10</span>
                </li>
