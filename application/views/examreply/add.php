    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Examreply Add</h3>
            </div>
            <?php echo form_open('examreply/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="exam" value="<?php echo $this->input->post('exam'); ?>" class="form-control" id="exam" />
						</div>
					</div>
					<div class="col-md-6">
