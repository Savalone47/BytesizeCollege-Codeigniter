    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Lessontopic Add</h3>
            </div>
            <?php echo form_open('lessontopic/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="topicAssignment" value="<?php echo $this->input->post('topicAssignment'); ?>" class="form-control" id="topicAssignment" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="lessonTopicStatus" value="<?php echo $this->input->post('lessonTopicStatus'); ?>" class="form-control" id="lessonTopicStatus" />
