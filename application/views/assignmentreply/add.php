    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Assignmentreply Add</h3>
            </div>
            <?php echo form_open('assignmentreply/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="assignmentRef" value="<?php echo $this->input->post('assignmentRef'); ?>" class="form-control" id="assignmentRef" />
						</div>
					</div>
					<div class="col-md-6">
