          	...
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="eventType" class="form-control">
								...
								{
									$selected = ($value == $this->input->post('eventType')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="eventTitle" value="<?php echo $this->input->post('eventTitle'); ?>" class="form-control" id="eventTitle" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="date" name="eventDate" value="<?php echo $this->input->post('eventDate'); ?>" class="has-datepicker form-control" id="eventDate" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="time" name="eventstatTime" value="<?php echo $this->input->post('eventstatTime'); ?>" class="form-control" id="eventstatTime" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="time" name="eventendTime" value="<?php echo $this->input->post('eventendTime'); ?>" class="form-control" id="eventendTime" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="eventLocation" value="<?php echo $this->input->post('eventLocation'); ?>" class="form-control" id="eventLocation" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="eventDescription" value="<?php echo $this->input->post('eventDescription'); ?>" class="form-control" id="eventDescription" />
					...
					<!--<div class="col-md-6">
						...
						<div class="form-group">
							<input type="file" name="eventImage" value="<?php echo $this->input->post('eventImage'); ?>" class="form-control" id="eventImage" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="eventStatus" value="<?php echo $this->input->post('eventStatus'); ?>" class="form-control" id="eventStatus" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="eventTimestamp" value="<?php echo $this->input->post('eventTimestamp'); ?>" class="form-control" id="eventTimestamp" />
