    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Groupdiscus Add</h3>
            </div>
            <?php echo form_open('groupdiscus/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="chapter" value="<?php echo $this->input->post('chapter'); ?>" class="form-control" id="chapter" />
						</div>
					</div>
					<div class="col-md-6">
